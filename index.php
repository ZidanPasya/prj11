    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        ...
        <div class="col-lg-6 order-1 order-lg-2">
          ...
          <img src="assets/img/logo/logoWhite.png" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
        </div>
      </div>
    </div>
        ...
        <div class="row gy-4 mt-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link" style="pointer-events: none;">Pembukaan</a></h4>
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link" style="pointer-events: none;">Pelaksanaan lomba</a></h4>
              <p>Pelaksanaan 6 cabang lomba akan dilaksanakan mulai tanggal 22 Oktober - 24 Oktober 2023</p>
            </div>
          </div><!--End Icon Box -->
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link" style="pointer-events: none;">Penutupan</a></h4>
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link" style="pointer-events: none;">Pengumuman Pemenang</a></h4>
              <p>Pengumuman pemenang akan dilaksanakan pada penutupan Pekan Raya Jurusan Ilmu Komputer 2023</p>
            </div>
          </div><!--End Icon Box -->
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            ...
            <p>Dalam rangka Dies Natalis Jurusan, kami ingin mengadakan serangkaian acara besar yang bersifat
              pengembangan keilmuan sebagai refleksi dari Visi dan Misi FMIPA yang menuntut kami untuk selalu menjujung
              tinggi tentang penelitian. Dies Natalis Jurusan Ilmu Komputer ini juga merupakan momentum untuk memberikan
              kesempatan kepada para pelajar dan umum di luar sana.</p>
            <p>Maka melalui acara ini kami berupaya untuk mengoptimalkan kehidupan saintis dengan kreatifitas yang kaya
              akan imajinasi dalam memberikan terobosan – terobosan baru bagi perkembangan ilmu pengetahuan dan
              teknologi. Acara ini juga sebagai ajang motivasi bagi kami untuk menjadi lebih baik, dengan adanya tekad
              untuk maju dan terus memberikan manfaat bagi civitas akademik Jurusan Ilmu Komputer khususnya dan civitas
    ...
    <section id="services" class="services sections-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Lomba</h2>
          <p>Dalam Pekan Raya Jurusan Ilmu Komputer 2023 ini terdapat beberapa cabang lomba yang dapat diikuti:</p>
        </div>
        ...
        <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item  position-relative">
              ...
              <a href="lomba/LCT.php" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <a href="lomba/CPC.php" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <a href="lomba/EN.php" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <a href="lomba/ML.php" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <a href="lomba/PES.php" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><a href="#"><img src="assets/img/clients/client-1.png" class="img-fluid" alt="">
            </div>
            <div class="swiper-slide"><a href="#"><img src="assets/img/clients/client-2.png" class="img-fluid" alt="">
            </div>
            <div class="swiper-slide"><a href="#"><img src="assets/img/clients/client-3.png" class="img-fluid" alt="">
            </div>
            <div class="swiper-slide"><a href="#"><img src="assets/img/clients/client-4.png" class="img-fluid" alt="">
            </div>
            <div class="swiper-slide"><a href="#"><img src="assets/img/clients/client-5.png" class="img-fluid" alt="">
            </div>
            <div class="swiper-slide"><a href="#"><img src="assets/img/clients/client-6.png" class="img-fluid" alt="">
            </div>
            <div class="swiper-slide"><a href="#"><img src="assets/img/clients/client-7.png" class="img-fluid" alt="">
            </div>
            <div class="swiper-slide"><a href="#"><img src="assets/img/clients/client-8.png" class="img-fluid" alt="">
            </div>
          </div>
        </div>
