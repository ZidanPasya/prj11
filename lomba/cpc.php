...
<head>
  ...
  <title>PRJ x HT XI | Competitive Programming Competition</title>
  <meta content="Pengumuman Competitive Programming Competition PRJxHT 11" name="description">
    ...
    <section class="lct">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h2>Competitive Programming Competition</h2>
        </div>
        <!-- <div class="col-lg-6">
        ...
        <div class="container">
          <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp content-cpc" data-wow-delay="0.1s">
              ...
              <p>
                Competitive Programming Competition adalah salah satu rangkaian kompetisi pada acara
                Pekan Raya Jurusan Ilmu Komputer Universitas Lampung. Competitive Programming
                menguji kemampuan peserta dalam menyelesaikan suatu masalah secara sistematis
                menggunakan bahasa pemrograman yang telah ditentukan, yaitu C/C++/Java. Perlombaan
                akan dilaksanakan pada platform hackerrank.com Penilaian akan dihitung berdasarkan
                kecepatan waktu dalam mengerjakan kode pemrograman serta poin yang diperoleh jika
                peserta berhasil menjawab dengan tepat. Peringkat Competitive Programming Competition
                menggunakan sistem papan skor dari platform hackerrank.
              </p>
              <p>
                Competitive Programming Competition terdiri dari sesi pemanasan, penyisihan dan babak
                final. Sesi pemanasan akan dilaksanakan paling lambat satu hari sebelum babak penyisihan
                dilakukan yang bersifat opsional atau tidak memengaruhi proses penilaian. Dianjurkan
                bagi
                peserta untuk mengikuti sesi pemanasan agar peserta memahami dan familiar dengan
                platform yang akan digunakan.
              </p>
              <p>
                Pada babak penyisihan dan final yang akan dilaksanakan secara daring melalui platform
                google meet. Diharapkan kepada seluruh peserta untuk mempersiapkan kebutuhan lomba
                dengan baik seperti device dan koneksi internet yang akan digunakan dalam kegiatan CPC.
              </p>


              <h1 class="display-6 mb-3 mt-4">Ketentuan Umum</h1>
              <p>
                Ketentuan umum yang berlaku untuk kategori lomba Competitive Programming
              </p>
              <ol>
                <li>
                  <p>
                    Peserta lomba adalah siswa/i SMA/MA/SMK sederajat Negeri/Swasta di seluruh
                    Indonesia kelas X s.d XII yang belum pernah mengikuti Olimpiade komputer tingkat
                    nasional yang diselenggarakan kementerian pendidikan dan kebudayaan
                  </p>
                </li>
                <li>
                  <p>
                    Peserta harus merupakan siswa/siswi yang belum dinyatakan lulus selama kompetisi
                    berlangsung, dibuktikan dengan Kartu Tanda Pelajar yang masih berlaku atau surat
                    keterangan resmi dari Sekolah.
                  </p>
                </li>
                <li>
                  <p>
                    Setiap peserta yang sudah terdaftar tidak dapat diganti oleh orang lain selama
                    kompetisi berlangsung dengan alasan apapun.
                  </p>
                </li>
                <li>
                  <p>
                    Peserta yang tidak memenuhi ketentuan diatas (nomor 1 sampai dengan 3) maka
                    dianggap
                    gugur.
                  </p>
                </li>
              ...
              <p>Lihat poster panduan <a href="https://drive.google.com/file/d/1gSmi1PObG2uW56Bjb_rYe23o9q04YItm/view?usp=sharing" class="link">
                  <bold class="btn btn-primary">Disini</bold>
                </a>.</p>
              </p>

              <h1 class="display-6 mb-3 mt-4">Contact Person</h1>
              <p>Reza Nur Ramadhan (+62 823-7561-9025) <br /> Cakrawangsa Veda Alkautsar (+62
                852-7306-6047)</p>

              <br>
              <a href="../form/cpc.php" class="btn-daftar">DAFTAR SEKARANG</a>
            </div>
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="position-relative overflow-hidden pe-5 pt-5 h-100" style="min-height: 400px;">
                <img loading="lazy" class="img" src="assets/img/cpc.png">
              </div>
            </div>
          </div>
        </div>
