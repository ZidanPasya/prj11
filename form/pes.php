...
<head>
  ...
  <meta content="Daftar Pro Evolution Soccer PRJ x HT XI Ignite : Unleashing the Spark of Youth Potential"
    name="description" />
  <meta content="PRJxHT, PRJxHT 11, Daftar, PES, Pro Evolution Soccer" name="keywords" />
  ...
  <div class="row bg-cpc m-0">
    ...
    <div class="col-12 col-md-6 mx-auto">
      <form action="action/pesAct" method="post" enctype="multipart/form-data" class="formm">
        <h1 style="color: white">Daftar Pro Evolution Soccer</h1>
