...
<body>
  ...
  <body background="cpc.jpg">
    ...
    <div class="row m-5">
      <div class="col-md-12" >
        <form action="formActionEssay" method="post" enctype="multipart/form-data" style="@keyframes fadeIn {
  from{
      opacity: 0.7;
  ...
  background-color: #0c2b4b; vertical-align: middle;" class="align-middle">
          ...
          <fieldset>
            ...
            if ($data["statusPembayaran"] == 2) {
              ...
              <?php
              if ($data["twibbon"] != null) {
                ?>
                <label class="" for="twibbon" style="color: white">Upload Twibbon</label>
                <small id="max" class="form-text text-muted">Max 1MB</small>
                <img loading="lazy" src="../twibbon/<?php echo $data["twibbon"]; ?>" class="my-2 w-100 h-50 img-upload">
                ...
                <div class="input-group">
                  <input type="hidden" name="id" value="<?= $id ?>">
                  <input required type="file" class="form-control mb-3" id="twibbon" name="twibbon"
                    accept="image/x-png,image/gif,image/jpeg" disabled>
                </div>
                <?php
              } ?>
              ...
              if ($data["twibbon"] != null) {
                ...
                ?>
                <label class="" for="gambar" style="color: white">Upload Twibbon</label>
                <small id="max" class="form-text text-muted">Max 1MB</small>
                <div class="input-group">
                  <input type="hidden" name="id" value="<?= $id ?>">
                  <input required type="file" class="form-control mb-3" id="twibbon" name="twibbon"
